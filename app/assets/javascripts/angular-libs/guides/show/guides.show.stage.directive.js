openFarmApp.directive("ofShowGuideStages", [
  "$http",
  "$modal",
  "stageService",
  "defaultService",
    ...
    return {
      ...
      controller: [
        ...
        function ($scope) {
          ...
          if ($scope.stage) {
            stageService.getStage($scope.stage.id).then(function (obj) {
          ...
          $scope.deleteStage = function (stage) {
            ...
            if (con) {
              stageService.deleteStageWithPromise(stage.id).then(function () {
          ...
          $scope.saveStageChanges = function (stage) {
            ...
            stageService.updateStageWithPromise(stage.id, { data: data }).then(
              function (response) {
