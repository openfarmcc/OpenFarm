(function ($, window, document, undefined) {
  ...
  Foundation.libs.clearing = {
    ...
    events: function (scope) {
      ...
      S(this.scope)
        .off(".clearing")
        .on("click.fndtn.clearing", "ul[" + this.attr_name() + "] li " + this.settings.open_selectors, function (
          e,
          current,
          target
        ) {
      ...
      S(this.scope)
        ...
        .on("touchmove.fndtn.clearing", ".visible-img", function (e) {
          ...
          if (typeof data.is_scrolling === "undefined") {
            data.is_scrolling = !!(
              data.is_scrolling || Math.abs(data.delta_x) < Math.abs(e.touches[0].pageY - data.start_page_y)
            );
          }
