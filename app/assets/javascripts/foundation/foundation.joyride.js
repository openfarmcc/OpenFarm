(function ($, window, document, undefined) {
  ...
  Foundation.libs.joyride = {
      ...
      $(this.scope)
        ...
        .on(
          ...
          function (e) {
            ...
            if (this.settings.$li.next().length === 0) {
              this.end();
    ...
    create: function (opts) {
      var buttonText =
          opts.$li.attr(this.add_namespace("data-button")) || opts.$li.attr(this.add_namespace("data-text")),
    ...
    show: function (init) {
      ...
      if (this.settings.$li === undefined || $.inArray(this.settings.$li.index(), this.settings.pause_after) === -1) {
        ...
        } else if (this.settings.$li && this.settings.$target.length === 0) {
          this.show();
        } else {
          this.end();
        }
        ...
        if (this.bottom()) {
          if (this.rtl) {
            this.settings.$next_tip.css({
              top:
                this.settings.$target.offset().top + nub_height + this.settings.$target.outerHeight() + topAdjustment,
              left:
          ...
          if (this.rtl) {
            this.settings.$next_tip.css({
              top:
                this.settings.$target.offset().top - this.settings.$next_tip.outerHeight() - nub_height + topAdjustment,
              left:
                this.settings.$target.offset().left +
                this.settings.$target.outerWidth() -
                this.settings.$next_tip.outerWidth(),
