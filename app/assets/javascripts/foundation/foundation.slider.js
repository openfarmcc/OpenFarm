          ...
          if (self.cache.active) {
            ...
            if ($.data(self.cache.active[0], 'settings').vertical) {
              self.calculate_position(
                self.cache.active,
                e.pageY || e.originalEvent.clientY || e.originalEvent.touches[0].clientY || e.currentPoint.y
              );
            } else {
              self.calculate_position(
                self.cache.active,
                e.pageX || e.originalEvent.clientX || e.originalEvent.touches[0].clientX || e.currentPoint.x
              );
            }
          }
        })
