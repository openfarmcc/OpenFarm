      ...
      if (success){
        ...
        $scope.guide.basic_needs.forEach(function(b){
          if (b.percent < 0.5){
            switch (b.name){
              case 'Sun / Shade':
                b.tooltip = 'Low because you have ' + b.have;
                break;
              case 'Location':
                b.tooltip = 'Low because your garden is ' + b.have;
                break;
              case 'Soil Type':
                b.tooltip = 'Low because you have ' + b.have + ' soil.';
                break;
              case 'Practices':
          ...
          if (b.percent >= 0.5 && b.percent < 0.75){
            switch (b.name){
              case 'Sun / Shade':
                b.tooltip = 'Medium because you have ' + b.have;
                break;
              case 'Location':
                b.tooltip = 'Medium because your garden is ' + b.have;
                break;
              case 'Soil Type':
                b.tooltip = 'Medium because you have ' + b.have + ' soil.';
                break;
              case 'Practices':
          ...
          if (b.percent >= 0.75){
            switch (b.name){
              case 'Sun / Shade':
                b.tooltip = 'High because you have ' + b.have;
                break;
              case 'Location':
                b.tooltip = 'High because your garden is ' + b.have;
                break;
              case 'Soil Type':
                b.tooltip = 'High because you have ' + b.have + ' soil.';
                break;
              case 'Practices':
                b.tooltip = 'You follow some of these practices in '+
                            'your gardens';
